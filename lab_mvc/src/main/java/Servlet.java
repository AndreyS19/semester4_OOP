// Пример сервлета - его можно запусть на томкате и удалить за не надобностью
...
//        out.println("<div><a href=\"/dotask\">Back</a></div>");
...
//        writer.println("Method GET from AddServlet");
        ...
        getServletContext().getRequestDispatcher("/view/basic.jsp").forward(request, response);
    }
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<div><a href=\"/lab_mvc\">Back</a></div>");
        out.println("</BODY></HTML>");
        out.flush();
        out.close();
    }
